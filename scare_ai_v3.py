...
# Built-in animal classes for now
...
FRAME_SKIP = 3                  # run full detection every 3rd frame
PERSON_CONFIRM_FRAMES = 2       # require same kind of detection across frames
    ...
    try:
        while True:
            ...
            if now < cooldown_until:
                ...
                cv2.imshow("Scare AI V3", annotated)
            ...
            if frame_count % FRAME_SKIP != 0:
                if last_annotated is not None:
                    cv2.imshow("Scare AI V3", last_annotated)
                else:
                    cv2.imshow("Scare AI V3", annotated)
