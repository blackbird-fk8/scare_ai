...
# Built-in animal classes to alarm on for now
...
# Lower = easier to accept as known
# Higher = stricter
FACE_MATCH_THRESHOLD = 0.25

# Relay settings
RELAY_PORT = "COM5"   # CHANGE THIS TO YOUR RELAY COM PORT
RELAY_BAUD = 9600

# Relay command bytes for your 2-channel relay board
# Relay 1 = strobe
# Relay 2 = horn
...
# Timing behavior
WARNING_DURATION = 10          # person seen but no face shown
ALARM_DURATION = 10            # how long alarm/strobe stays active
KNOWN_COOLDOWN = 3             # cooldown after known person seen
POST_ALARM_COOLDOWN = 5        # cooldown after alarm event
EVENT_IMAGE_COUNT = 3
...
# ============================================================
# OPENVINO FACE RECOGNITION SETUP
# ============================================================
...
def main():
    ...
    # Warning state for person seen but face not shown
    ...
    try:
        while True:
            ...
            if now < cooldown_until:
                ...
                cv2.imshow("Scare AI Full", annotated)
            ...
            if result.boxes is not None:
                for box in result.boxes:
                    ...
                    # ------------------------------------
                        ...
                        event_text = f"class={cls_name}, conf={conf:.3f}"
